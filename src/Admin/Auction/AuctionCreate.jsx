        ...
        <>
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 mt-14 max-w-screen-lg">
                    <h1 data-cy={'auction-create'} className={'text-4xl font-bold text-black'}>
                        Create auction
                    </h1>
                    ...
                    <form data-cy={'auction-create-form'} onSubmit={postCreateAuction}>
                        <div className={'flex flex-col'}>
                            ...
                            <select defaultValue={''} name="product" id="product" onChange={(e) => handleFormChange(e.target.value, 'productId')}>
                        ...
                        <div className={'flex flex-col'}>
                            ...
                            <input type={'datetime-local'} id={'startDateTime'} name={'startDateTime'} onChange={(e) => handleFormChange(e.target.value, 'startDateTime')} />
                        </div>
                        <div className={'flex flex-col'}>
                            <label htmlFor="startDateTime">Duration in seconds</label>
                            <input type={'number'} id={'durationInSeconds'} name={'durationInSeconds'} onChange={(e) => handleFormChange(e.target.value, 'durationInSeconds')} />
                        </div>
                        <div>
                            {formIsLoading && (
