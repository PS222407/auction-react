        ...
        <>
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 mt-14 max-w-screen-lg">
                    <h1 data-cy={'category-edit'} className={'text-4xl font-bold text-black'}>
                        Edit Category
                    </h1>
                    ...
                    <form>
                        <div className={'flex flex-col'}>
                            ...
                            <input value={categoryForm.name} type={'text'} id={'name'} name={'name'} onChange={(e) => handleFormChange(e.target.value, 'name')} />
                        </div>
                        <div className={'flex flex-col'}>
                            <label htmlFor="name">Icon (svg from fontawesome e.g.)</label>
                            <textarea value={categoryForm.icon} id={'icon'} name={'icon'} onChange={(e) => handleFormChange(e.target.value, 'icon')} />
                        </div>
                        <div>
                            {formIsLoading && (
