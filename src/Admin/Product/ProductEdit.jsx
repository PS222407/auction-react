        ...
        <>
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 mt-14 max-w-screen-lg">
                    <h1 data-cy={'product-edit'} className={'text-4xl font-bold text-black'}>
                        Edit product
                    </h1>
                    ...
                    <form>
                        <div className={'flex flex-col'}>
                            ...
                            <input value={productForm.name} type={'text'} id={'name'} name={'name'} onChange={(e) => handleFormChange(e.target.value, 'name')} />
                        </div>
                        <div className={'flex flex-col'}>
                        ...
                        <div className={'flex flex-col'}>
                            ...
                            <textarea value={productForm.description} id={'description'} name={'description'} onChange={(e) => handleFormChange(e.target.value, 'description')} />
                        </div>
                        <div className={'flex flex-col'}>
                        ...
                        <div className={'flex flex-col'}>
                            ...
                            {productForm.category !== undefined && (
                                <select defaultValue={productForm.category === null ? '' : productForm.category} name="category" id="category" onChange={(e) => handleFormChange(e.target.value, 'category')}>
