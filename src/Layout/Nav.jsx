...
function Nav() {
    ...
    return (
        <>
            <nav style={{ backgroundColor: '#FDA700' }} className="flex-no-wrap relative flex w-full items-center justify-between bg-zinc-50 py-2 shadow-dark-mild dark:bg-neutral-700 lg:flex-wrap lg:justify-start lg:py-4">
                <div className="flex w-full flex-wrap items-center justify-between px-3">
                    ...
                    >
                        <span className="[&>svg]:w-7 [&>svg]:stroke-white dark:[&>svg]:stroke-white">
                    ...
                    <div className="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto" id="navbarSupportedContent1" data-twe-collapse-item="">
                        <Link to={`/`} className={'mb-4 me-5 ms-2 mt-3 flex items-center text-white font-bold lg:mb-0 lg:mt-0'}>
                            {config?.APP_NAME}
                        </Link>
                    ...
                    <div className="relative flex items-center">
                        ...
                        <div className="relative" data-twe-dropdown-ref="" data-twe-dropdown-alignment="end">
                            <a className="flex items-center whitespace-nowrap" href="#" id="dropdownMenuButton2" role="button" data-twe-dropdown-toggle-ref="" aria-expanded="false">
