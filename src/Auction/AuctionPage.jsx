                                    ...
                                    <form onSubmit={submitBid}>
                                        ...
                                        <div className={'flex flex-col md:flex-row'}>
                                            <div className={'flex'}>
                                                ...
                                                <InputMoney disabled={isCompleted} name={'price'} label={'undefined'} defaultValue={price} setValue={(value) => setPrice(value)} />
                                            </div>
                                            <button disabled={isCompleted} className={`py-2 px-8 ${isCompleted ? 'bg-gray-100' : 'bg-yellow-500'}`}>
                                                Place bid
                                            </button>
                                        </div>
                                    </form>
